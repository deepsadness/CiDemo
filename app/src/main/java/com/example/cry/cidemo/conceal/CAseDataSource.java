...
public class CAseDataSource implements DataSource {
     ...
     */
    public CAseDataSource(Context context, TransferListener<? super DataSource> listener,
...
//        Timber.e("解密：000000," + scheme + ",path:" + dataSpec.uri.getPath());
        if (Util.isLocalFileUri(dataSpec.uri)) {
            ...
            if (dataSpec.uri.getPath().endsWith(".case")) {
                ConcealDataSource concealDataSource =
                        new ConcealDataSource(getFileDataSource());
                dataSource = concealDataSource;
            } else {//否则，正常解析mp3
